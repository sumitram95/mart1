                                ...
                                if ($result && mysqli_num_rows($result) > 0) {
                                    ...
                                    while ($row = mysqli_fetch_assoc($result)) {
                                        ...
                                        <tr>
                                            ...
                                            <td
                                                class="border-t-0 px-6 align-middle border-l-0 border-r-0 whitespace-nowrap p-4">
                                                <a href="./view.php?id=<?php echo $row['id']; ?>" class="btn"><i
                                                        class="fa-solid fa-eye"></i></a>
                                                <a href="./edit.php?id=<?php echo $row['id']; ?>" class="btn"><i
                                                        class="fa-solid fa-pen-to-square"></i></a>
                                                <a href="./delete.php?id=<?php echo $row['id']; ?>" class="btn text-red-500"><i
