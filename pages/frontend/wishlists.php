    ...
    <div class="max-auto overflow-x-hidden">
      ...
      <div class="px-6 mt-8">
        <div class="flex justify-center mb-4">
          <div class="w-3/4">
            <h1 class="font-semibold text-2xl text-gray">Wishlists</h1>
          </div>
        </div>
        <div class="flex justify-center mb-4 product">
          <div
            class="flex w-3/4 justify-between items-center border border-green-600 rounded-md px-4 py-3"
          >
            <!-- product -->
        ...
        <div class="flex justify-center mt-8">
          <div class="w-3/4">
            <a href="../shopping-cart.html" class="text-gray font-semibold"
              ><i class="fa-solid fa-arrow-left"></i> Back to cart</a
            >
          </div>
        </div>
      </div>
