...
<body class="overflow-x-hidden">
  <div class="max-auto overflow-x-hidden">
    ...
    <nav class="flex mt-10 items-center gap-7 px-4">
      ...
      <div class="flex gap-7">
        ...
        <a href="./contact.php" class="font-semibold text-lg active">Contact</a>
      </div>
    </nav>
    <!-- end nav-bar -->
      ...
      <div class="py-6 px-3 mx-4 bg-green-white rounded-md flex gap-6">
        ...
        <div class="px-8 py-4 h-[500px] mx-3 w-1/2 border text-gray-700">
          ...
          <form action="">
            ...
            <input type="text" name="" class="outline-none bg-transparent border-b-1 w-full px-2 py-1"
  ...
  <div class="px-4 mt-10">
    <iframe class="w-full" height="400px" id="gmap_canvas"
      src="https://maps.google.com/maps?q=636+5th+Ave%2C+New+York&t=&z=13&ie=UTF8&iwloc=&output=embed" frameborder="0"
